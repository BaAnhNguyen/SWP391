...
const resources = {
  en: {
    translation: {
      ...
      "needRequest.compatibleBloodUnits": "Compatible Blood Units",
      "needRequest.fetchBloodUnitsError":
        "Error fetching compatible blood units",
      "needRequest.invalidBloodType": "Invalid or unsupported blood type",
      "needRequest.supportedTypes": "Supported types",
      "needRequest.requestNotFound": "Blood request not found",
  ...
  vi: {
    translation: {
      ...
      "needRequest.compatibleBloodUnits": "Đơn Vị Máu Tương Thích",
      "needRequest.fetchBloodUnitsError": "Lỗi khi lấy đơn vị máu tương thích",
      "needRequest.invalidBloodType": "Loại máu không hợp lệ hoặc không được hỗ trợ",
      "needRequest.supportedTypes": "Các loại máu được hỗ trợ",
      "needRequest.requestNotFound": "Không tìm thấy yêu cầu máu",
