...
const resources = {
  en: {
    translation: {
      ...
      "profile.selectBloodGroup": "Select blood group", "profile.identityCard": "Identity Card",
      "profile.identityCard.hint": "Enter your identity card number", "profile.phoneNumber": "Phone Number",
      ...
      "profile.streetPlaceholder": "Enter your street address", "profile.district": "District",
  ...
  vi: {
    translation: {
      ...
      "profile.selectBloodGroup": "Chọn nhóm máu", "profile.identityCard": "Số CMND",
      "profile.identityCard.hint": "Nhập số CMND của bạn", "profile.phoneNumber": "Số Điện Thoại",
      ...
      "profile.streetPlaceholder": "Nhập tên đường của bạn", "profile.district": "Quận",
