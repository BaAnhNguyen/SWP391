    ...
    <div className="home-page">
          ...
          <div className="blood-types-grid">
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> A+, AB+
                </p>
                <p>
                  <strong>Can receive from:</strong> A+, A-, O+, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> A+, A-, AB+, AB-
                </p>
                <p>
                  <strong>Can receive from:</strong> A-, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> B+, AB+
                </p>
                <p>
                  <strong>Can receive from:</strong> B+, B-, O+, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> B+, B-, AB+, AB-
                </p>
                <p>
                  <strong>Can receive from:</strong> B-, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> AB+ only
                </p>
                <p>
                  <strong>Can receive from:</strong> All Blood Types
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> AB+, AB-
                </p>
                <p>
                  <strong>Can receive from:</strong> A-, B-, AB-, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> A+, B+, AB+, O+
                </p>
                <p>
                  <strong>Can receive from:</strong> O+, O-
                </p>
              </div>
            </div>
            ...
            <div className="blood-type-card">
              ...
              <div className="compatibility">
                <p>
                  <strong>Can donate to:</strong> All Blood Types
                </p>
                <p>
                  <strong>Can receive from:</strong> O- only
                </p>
        ...
        <div className="container">
          ...
          <div className="testimonials-container">
            <div className="testimonial">
              <div className="quote">
                "I've been donating blood for over 10 years now. It's just an
                hour of my time, but it means the world to someone in need."
              </div>
              <div className="author">- Sarah Johnson</div>
            </div>
            <div className="testimonial">
              <div className="quote">
                "After my son's accident, he needed multiple transfusions. Now I
                donate regularly to give back and help others like him."
              </div>
              <div className="author">- Michael Rodriguez</div>
            </div>
            <div className="testimonial">
              <div className="quote">
                "It's such a simple way to make a big difference. I feel great
                knowing my donation directly helps save lives!"
              </div>
      ...
      <section className="cta">
        <div className="container cta-container">
          ...
          <p>
            Schedule your blood donation appointment today and join our
