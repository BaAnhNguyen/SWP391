  ...
  return (
    <div className="need-request-list-container">
      <div className="list-header">
        <div>
          <h2>
            {isStaff ? t('needRequest.listTitleAll') : t('needRequest.listTitleMy')}
            <span className={`role-indicator ${isStaff ? 'staff' : 'member'}`}>
              {isStaff ? t('admin.users.role.staff') : t('admin.users.role.member')}
            </span>
          </h2>
          {!isStaff && (
        ...
        <div className="filter-container">
          ...
          >
            ...
            <option value="Fullfilled">{t('needRequest.status.fulfilled')}</option>
            ...
            >
                ...
                <div className="request-main-info">
                  ...
                  <div className="request-details">
                    <span className="component">
                      {t(`needRequest.component.${request.component.toLowerCase()}`)}
                    </span>
                    <span className="units">
                      {request.units} {request.units === 1 ? t('needRequest.unit') : t('needRequest.units')}
                    </span>
                  </div>
                </div>
                <div 
              ...
              <div className="request-content">
                <div className="request-by">
                  <strong>{t('needRequest.requestedBy')}:</strong> {request.createdBy?.name || 'Unknown'}
                </div>
